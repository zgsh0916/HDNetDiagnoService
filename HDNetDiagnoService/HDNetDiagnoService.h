 ...
 *
 */
@protocol HDNetDiagnoServiceDelegate <NSObject>
/**
 * 告诉调用者诊断开始
 */
 ...
 */
@interface HDNetDiagnoService : NSObject {
}
@property (nonatomic, weak, readwrite)
    id<HDNetDiagnoServiceDelegate> delegate;      //向调用者输出诊断信息接口
